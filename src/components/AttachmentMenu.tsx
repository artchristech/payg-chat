  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="w-8 h-8 bg-gray-600 text-gray-300 rounded-full hover:bg-gray-500 hover:text-gray-100 transition-all duration-200 flex items-center justify-center"
        title="Attach file"
      >
      ...
      {isMenuOpen && (
        <div className="absolute bottom-full left-0 mb-2 bg-gray-700 rounded-lg shadow-lg z-50 min-w-[120px]">
          <div className="p-1">
            <button
              onClick={handleImageClick}
              className="w-full flex items-center gap-3 px-3 py-2 text-sm text-gray-100 hover:bg-gray-600 rounded-md transition-colors"
            >
